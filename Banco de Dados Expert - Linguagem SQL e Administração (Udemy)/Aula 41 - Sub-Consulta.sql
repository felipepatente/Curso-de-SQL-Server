...
Porem, nao estamos filtrando a tabela PEDIDO de modo que se houver 
algum COD_CLI na tabela PEDIDOS que não se encontre na tabela CLIENTE o 
valor NULL sera retornado para o campo
...
/*
Nesta Query vamos trazer todos clientes e atraves de subconsulta o valor de suas compras.
*/
