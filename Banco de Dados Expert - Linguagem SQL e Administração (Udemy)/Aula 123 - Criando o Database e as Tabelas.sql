...
CREATE TABLE ORDEM_PROD(
	...
	CONSTRAINT FK_OP1 FOREIGN KEY (COD_MAT_PROD) REFERENCES MATERIAL (COD_MAT)
)
...
CREATE TABLE APONTAMENTOS(
	...
	CONSTRAINT FK_APON1 FOREIGN KEY (COD_MAT_PROD) REFERENCES MATERIAL (COD_MAT),
	CONSTRAINT FK_APON2 FOREIGN KEY (ID_ORDEM) REFERENCES ORDEM_PROD (ID_ORDEM)
)
...
CREATE TABLE FICHA_TECNICA(
	...
	CONSTRAINT FK_F1C1 FOREIGN KEY (COD_MAT_PROD) REFERENCES MATERIAL (COD_MAT),
	CONSTRAINT FK_F1C2 FOREIGN KEY (COD_MAT_NECES) REFERENCES MATERIAL (COD_MAT)
)
...
CREATE TABLE CONSUMO(
	...
	CONSTRAINT FK_CONS1 FOREIGN KEY (COD_MAT_NECES) REFERENCES MATERIAL (COD_MAT),
