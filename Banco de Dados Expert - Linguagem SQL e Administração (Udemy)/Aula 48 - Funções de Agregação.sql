...
--AVG Retorna a media dos valores em um grupo. Valores nulos sao ignorados
...
--MIN Retorna o valor minimo na expressao. Pode ser seguido pela clausula OVER
...
--SUM pode ser usado exclusivamente com colunas numericas. Valores nulos são ignorados.
...
SELECT a.nome_mun,
	   ...
	   b.populacao as senso_2013,100/cast(a.populacao as float)*cast(b.populacao as float)-100 pct_cresc
from cidades a
...
--GROUPING_ID
/*
E uma função que calcula o nivel de agrupamento. 
...
--VAR Retorna a variancia estatística de todos os valores da expressão especificada
...
--VARP Retorna a variancia estatística para o preenchimento 
